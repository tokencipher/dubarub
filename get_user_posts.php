...
include ("php_inc/inc_db_qp4.php");
   if ($conn != FALSE) {
     ...
     $table = "post";
     $sql = "SELECT u_id, p_id, avatar, thumbnail, title, photo_url, video_url, video_mp4, image, video, external, file_size, likes, comments, photo_cred, entry, created_at, user_name, display, mime_type FROM $table WHERE u_id=$user_id";
     $object = array();
     $x = 0;
