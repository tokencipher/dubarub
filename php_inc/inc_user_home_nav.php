<nav class="navbar navbar-default navbar-fixed-top">
    <div id="header" class="w3-container w3-white" style="opacity:0.6">
      <img style="position:relative;margin-top:8px" src="img/dubarub.png" alt="dubarub" id="dub" height="40" width="47" class="w3-circle" />
      <span style="position:relative;top:10px" id="logoTitle"> closed beta </span>
      <div class="dropdown">
