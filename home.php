...
<!-- Start of Dynamic Content Section -->
  ...
  <div id="profile_bio_container">  
    ...
    <div id="bio_action_container" class="flex-container">
      ...
      <i id="inbox" class="fa fa-envelope action_items" aria-hidden="true"><span style="position:absolute;top:-5px;right:-5px;padding:5px10px;border-radius:50%;background:red;color:white" class="badge"></span></i>
